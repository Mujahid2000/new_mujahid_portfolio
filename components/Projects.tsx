...
const projects = [
  {
    ...
    fe: 'https://github.com/Mujahid2000/myJob',
    be: 'https://github.com/Mujahid2000/Job-server',
  },
  {
    n: '02',
    name: 'DYNAMIC RBAC',
  ...
  },
  {
    n: '03',
    name: 'AMAR-STORAGE',
    sub: 'WAREHOUSING & INVENTORY MANAGEMENT',
    badge: 'PAID',
    desc: 'Created a subscription-driven warehouse management system with order tracking, inventory control, and quantity-based dynamic pricing for storage. ',
